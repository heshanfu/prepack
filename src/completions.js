...
export class Completion {
  constructor(value: Value, location: ?BabelNodeSourceLocation, target?: ?string) {
    ...
    invariant(this.constructor.name !== "Completion", "Completion is an abstract base class");
  }
...
export class NormalCompletion extends Completion {
  constructor(value: Value, location: ?BabelNodeSourceLocation, target?: ?string) {
    ...
    invariant(this.constructor.name !== "NormalCompletion", "NormalCompletion is an abstract base class");
  }
}
...
export class AbruptCompletion extends Completion {
  constructor(value: Value, location: ?BabelNodeSourceLocation, target?: ?string) {
    super(value, location, target);
    invariant(this.constructor.name !== "AbruptCompletion", "AbruptCompletion is an abstract base class");
  }
}
